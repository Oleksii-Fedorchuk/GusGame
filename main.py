...
def create_enemy():
    ...
    enemy_rec = pygame.Rect(WIDTH, random.randint(0, HEIGHT), *enemy_size)
...
def create_bonus():
    ...
    bonus_rec = pygame.Rect(random.randint(0, WIDTH), 0, *bonus_size)
...
pygame.time.set_timer(CREATE_BONUS, random.randint(1500, 5000))
